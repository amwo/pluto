...
| 10 | systemd + deploy notes | `deploy/pluto.service` (Type=exec, KillSignal=SIGINT 30s, ProtectSystem=strict), `deploy/README.md` (bootstrap / build+ship / secrets / ops / rollback / live transition checklist) | ✅ done (milestone 10 artifacts) |
